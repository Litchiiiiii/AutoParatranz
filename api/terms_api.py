...
class TermsApi:
    ...
    async def create_term(
        ...
        _param = self._create_term_serialize(
    ...
    def _create_term_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/projects/{projectId}/terms',
    ...
    async def delete_term(
        ...
        _param = self._delete_term_serialize(
            project_id=project_id,
            term_id=term_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _delete_term_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/projects/{projectId}/terms/{termId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_terms(
        ...
        _param = self._get_terms_serialize(
            project_id=project_id,
            page=page,
            page_size=page_size,
            _request_auth=_request_auth,
    ...
    async def get_terms_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTerms200Response]:
        """术语列表
    ...
    async def import_terms(
        ...
        page: Annotated[Optional[StrictInt], Field(description="页码")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=800, strict=True, ge=1)]], Field(description="每页数量")] = None,
        file: Annotated[Optional[Union[StrictBytes, StrictStr]], Field(description="JSON文件数据，示例如下 ```  [     {       \\\"term\\\": \\\"apple\\\",       \\\"translation\\\": \\\"苹果\\\",       \\\"pos\\\": \\\"noun\\\",       \\\"note\\\": \\\"注释\\\",       \\\"variants\\\": [\\\"apples\\\"]     }   ] ``` ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param page_size: 每页数量
        :type page_size: int
        :param file: JSON文件数据，示例如下 ```  [     {       \\\"term\\\": \\\"apple\\\",       \\\"translation\\\": \\\"苹果\\\",       \\\"pos\\\": \\\"noun\\\",       \\\"note\\\": \\\"注释\\\",       \\\"variants\\\": [\\\"apples\\\"]     }   ] ``` 
        :type file: bytearray
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._import_terms_serialize(
            project_id=project_id,
            page=page,
            page_size=page_size,
            file=file,
    ...
    async def import_terms_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ImportTerms200Response]:
        """批量导入术语
    ...
    async def save_term(
        ...
        _param = self._save_term_serialize(
            project_id=project_id,
            term_id=term_id,
            term=term,
            _request_auth=_request_auth,
