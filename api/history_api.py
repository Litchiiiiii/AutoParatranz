...
class HistoryApi:
    ...
    async def get_file_revisions(
        ...
        type: Annotated[Optional[StrictStr], Field(description="指定类型获取历史，同revision中的type定义")] = None,
        ...
        :param file: 指定文件获取历史
        :type file: float
        :param type: 指定类型获取历史，同revision中的type定义
        :type type: str
        ...
        _param = self._get_file_revisions_serialize(
    ...
    async def get_file_revisions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetFileRevisions200Response]:
        """文件历史
    ...
    def _get_file_revisions_serialize(
        self,
        project_id,
        page,
        page_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{projectId}/files/revisions',
    ...
    async def get_history(
        ...
        page: Annotated[Optional[StrictInt], Field(description="页码")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=800, strict=True, ge=1)]], Field(description="每页数量")] = None,
        project: Annotated[Optional[StrictInt], Field(description="项目ID")] = None,
        uid: Annotated[Optional[StrictInt], Field(description="用户ID")] = None,
        tid: Annotated[Optional[StrictInt], Field(description="词条ID，当 type 为 text 时指定，用于获取某一词条的全部历史记录，**指定后分页失效** ")] = None,
        type: Annotated[Optional[StrictStr], Field(description="历史记录类型 - `text` 词条历史  - `import` 导入历史，同 project 一起使用  - `comment` 评论记录，同 project 或 uid 一起使用 ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param uid: 用户ID
        :type uid: int
        :param tid: 词条ID，当 type 为 text 时指定，用于获取某一词条的全部历史记录，**指定后分页失效** 
        :type tid: int
        :param type: 历史记录类型 - `text` 词条历史  - `import` 导入历史，同 project 一起使用  - `comment` 评论记录，同 project 或 uid 一起使用 
        :type type: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    async def get_term_history(
        ...
        _param = self._get_term_history_serialize(
            project_id=project_id,
            term_id=term_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def get_term_history_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTermHistory200Response]:
        """术语历史
    ...
    def _get_term_history_serialize(
        self,
        project_id,
        term_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{projectId}/terms/{termId}/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
