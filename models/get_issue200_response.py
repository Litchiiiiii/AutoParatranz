...
class GetIssue200Response(BaseModel):
    """
    GetIssue200Response
    """ # noqa: E501
    activities: Optional[List[Reply]] = Field(default=None, description="讨论的回复及操作记录")
    subscribers: Optional[List[User]] = Field(default=None, description="订阅讨论的用户列表")
