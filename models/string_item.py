...
class StringItem(BaseModel):
    ...
    词条
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="词条ID")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    key: Optional[StrictStr] = Field(default=None, description="词条键值，文件内必须唯一")
    original: Optional[StrictStr] = Field(default=None, description="词条原文")
    translation: Optional[StrictStr] = Field(default=None, description="词条译文")
    file: Optional[Dict[str, Any]] = Field(default=None, description="词条所属的文件详情")
    file_id: Optional[StrictInt] = Field(default=None, description="词条所属文件ID", alias="fileId")
    stage: Optional[Stage] = None
    project: Optional[StrictInt] = Field(default=None, description="词条所属项目ID")
    uid: Optional[StrictInt] = Field(default=None, description="词条最后编辑用户的ID")
    context: Optional[StrictStr] = Field(default=None, description="词条上下文，可通过上传文件或API添加")
    words: Optional[StrictInt] = Field(default=None, description="词条原文字数（暂不支持中日韩计数）")
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "key", "original", "translation", "file", "fileId", "stage", "project", "uid", "context", "words"]
