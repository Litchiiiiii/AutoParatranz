...
class Job(BaseModel):
    ...
    params: Optional[Dict[str, Any]] = Field(default=None, description="任务执行参数")
    project: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="项目ID")
    uid: Optional[StrictInt] = Field(default=None, description="创建者用户ID")
    type: Optional[StrictStr] = Field(default=None, description="任务类型")
    status: Optional[StrictInt] = Field(default=None, description="任务状态，0 - 未开始，1 - 正在执行，2 - 执行成功，-1 - 执行失败")
    result: Optional[Dict[str, Any]] = Field(default=None, description="任务结果")
    __properties: ClassVar[List[str]] = ["id", "createdAt", "startedAt", "finishedAt", "scheduledAt", "params", "project", "uid", "type", "status", "result"]
