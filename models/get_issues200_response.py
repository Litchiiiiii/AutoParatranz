...
class GetIssues200Response(BaseModel):
    """
    ...
    closed_count: Optional[StrictInt] = Field(default=None, description="已关闭的讨论数量", alias="closedCount")
    open_count: Optional[StrictInt] = Field(default=None, description="讨论中的讨论数量", alias="openCount")
    results: Optional[List[GetIssues200ResponseResultsInner]] = None
    __properties: ClassVar[List[str]] = ["page", "pageSize", "rowCount", "pageCount", "closedCount", "openCount", "results"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "closedCount": obj.get("closedCount"),
            "openCount": obj.get("openCount"),
            "results": [GetIssues200ResponseResultsInner.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
