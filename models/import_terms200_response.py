...
class ImportTerms200Response(BaseModel):
    """
    ImportTerms200Response
    """ # noqa: E501
    inserted: Optional[StrictInt] = Field(default=None, description="新创建的术语数量")
    updated: Optional[StrictInt] = Field(default=None, description="已更新的术语数量")
    deleted: Optional[StrictInt] = Field(default=None, description="已删除的术语数量")
    __properties: ClassVar[List[str]] = ["inserted", "updated", "deleted"]
