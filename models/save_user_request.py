...
class SaveUserRequest(BaseModel):
    ...
    bio: Optional[Annotated[str, Field(strict=True, max_length=140)]] = Field(default=None, description="个人介绍")
    avatar: Optional[StrictStr] = Field(default=None, description="头像图片链接")
    __properties: ClassVar[List[str]] = ["nickname", "bio", "avatar"]
