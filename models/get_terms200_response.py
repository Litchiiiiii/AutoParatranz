...
class GetTerms200Response(BaseModel):
    """
    GetTerms200Response
    """ # noqa: E501
    ...
    results: Optional[List[Term]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "results": [Term.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
