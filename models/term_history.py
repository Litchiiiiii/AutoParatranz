...
class TermHistory(BaseModel):
    ...
    tid: Optional[StrictInt] = Field(default=None, description="术语ID")
    ...
    target: Optional[TermHistoryTarget] = None
    operation: Optional[StrictStr] = Field(default=None, description="历史记录操作类型")
    __properties: ClassVar[List[str]] = ["id", "createdAt", "field", "uid", "tid", "from", "to", "target", "operation"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "target": TermHistoryTarget.from_dict(obj.get("target")) if obj.get("target") is not None else None,
