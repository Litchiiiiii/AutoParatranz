...
class SaveFileRequest(BaseModel):
    ...
    SaveFileRequest
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="文件名，需填写完整路径")
    extra: Optional[Dict[str, Any]] = Field(default=None, description="JSON 格式，可随意填写需要的保存的其他信息")
    __properties: ClassVar[List[str]] = ["name", "extra"]
