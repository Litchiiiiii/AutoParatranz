...
class Score(BaseModel):
    ...
    base: Optional[StrictInt] = Field(default=None, description="贡献值基准，翻译为1，编辑为0.5，审核为0.2")
    multiplier: Optional[StrictInt] = Field(default=None, description="贡献值乘数，公式为 1 + (词数 - 1) * 0.1")
    value: Optional[StrictInt] = Field(default=None, description="基准乘以乘数得到的最终值")
    __properties: ClassVar[List[str]] = ["id", "createdAt", "project", "uid", "base", "multiplier", "value"]
