...
class Member(BaseModel):
    ...
    total_points: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="成员PP值", alias="totalPoints")
    translated: Optional[StrictInt] = Field(default=None, description="翻译条数")
    edited: Optional[StrictInt] = Field(default=None, description="编辑条数")
    reviewed: Optional[StrictInt] = Field(default=None, description="审核条数")
    note: Optional[StrictStr] = Field(default=None, description="成员备注")
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "uid", "user", "project", "permission", "totalPoints", "translated", "edited", "reviewed", "note"]
