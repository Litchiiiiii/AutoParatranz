...
class File(BaseModel):
    ...
    project: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    format: Optional[StrictStr] = Field(default=None, description="文件格式，由系统自动计算")
    total: Optional[StrictInt] = Field(default=None, description="文件总词条数")
    translated: Optional[StrictInt] = Field(default=None, description="已翻译词条数")
    disputed: Optional[StrictInt] = Field(default=None, description="有疑问的词条数")
    checked: Optional[StrictInt] = Field(default=None, description="已检查的词条数")
    reviewed: Optional[StrictInt] = Field(default=None, description="已审核的词条数")
    hidden: Optional[StrictInt] = Field(default=None, description="已隐藏的词条数")
    locked: Optional[StrictInt] = Field(default=None, description="已锁定的词条数")
    words: Optional[StrictInt] = Field(default=None, description="总词数")
    hash: Optional[StrictStr] = Field(default=None, description="上一次文件更新或创建时的原文件哈希值")
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "modifiedAt", "name", "project", "format", "total", "translated", "disputed", "checked", "reviewed", "hidden", "locked", "words", "hash"]
