...
class MailFromUser(BaseModel):
    ...
    last_visit: Optional[datetime] = Field(default=None, alias="lastVisit")
    ...
    bio: Optional[StrictStr] = Field(default=None, description="用户简介")
    avatar: Optional[StrictStr] = Field(default=None, description="用户头像")
    email: Optional[StrictStr] = Field(default=None, description="用户邮箱")
    credit: Optional[StrictInt] = Field(default=5, description="用户信用值，低于0将会被限制使用")
    translated: Optional[StrictInt] = Field(default=None, description="用户翻译的词条数量")
    edited: Optional[StrictInt] = Field(default=None, description="用户编辑的词条数量")
    reviewed: Optional[StrictInt] = Field(default=None, description="用户审核的词条数量")
    commented: Optional[StrictInt] = Field(default=None, description="用户发布的评论数")
    points: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="用户的贡献值（PP），计算公式为 1 * 翻译词条总词数 + 0.5 * 编辑词条总词数 + 0.2 * 审核词条总词数")
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "lastVisit", "username", "nickname", "bio", "avatar", "email", "credit", "translated", "edited", "reviewed", "commented", "points"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "lastVisit": obj.get("lastVisit"),
            "username": obj.get("username"),
            "nickname": obj.get("nickname"),
            "bio": obj.get("bio"),
            "avatar": obj.get("avatar"),
            "email": obj.get("email"),
            "credit": obj.get("credit") if obj.get("credit") is not None else 5,
            "translated": obj.get("translated"),
            "edited": obj.get("edited"),
            "reviewed": obj.get("reviewed"),
            "commented": obj.get("commented"),
